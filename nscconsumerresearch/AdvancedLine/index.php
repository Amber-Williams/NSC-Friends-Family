...
<!--TO PUT IN CSS CONSOLDATED SHEET -->
<style>
	.add-list-bullets {
		list-style: inherit;
...
<div class="row hidden-xs">
	<div id="tabs" class="tabs">
		...
		<div id="tabs-1">
			<div class="row">
				<h1 class="productHeader">NERIUM ADVANCED NIGHTLY FACE TREATMENT</h1>
				...
				<ul class="add-list-bullets move-points-center">
					<li><p>Sun Damaged Skin</p></li>
					<li><p>Signs of Aging</p></li>
					<li><p>Skin Imperfections</p></li>
					<li><p>Blemishes/Spots/Discoloration</p></li>
					<li><p>Skin Elasticity</p></li>
					<li><p>Cellulite</p></li>
					<li><p>Urban/Environmental stressor factors </p></li>
					<li><p>Underlying factors that damage skin</p></li>
				</ul>
				<hr class="redHR" />
			</div>
		...
		<div id="tabs-3">
			<div class="row">
				<h1 class="productHeader">NERIUMFIRM ADVANCED FIRMING BODY CREAM</h1>
				<p class="dpTherapy">
				...
				<div>
					...
					<div class="row">
						...
						<ul class="add-list-bullets">
							...
							<li><p>Cellulite</p></li>
							<li><p>Urban/Environmental stressor factors </p></li>
							<li><p>Underlying cause of damaged skin</p></li>
						</ul>
						<hr class="redHR" />
					</div>
		...
		<h3><img src="images/therapypage/AdvancedLine-Body-Selector-SM.jpg" class="center-block" alt="NeriumFirm Body and Cellulite Cream"></h3>
				<div>
					<div class="row">
						...
						<p class="dpTherapy">
						Advanced NeriumFirm Body Cellulite Cream with its latest slim-figuring technology helps decrease the appearance of fat tissue, smooth cellulite, and enhance skin elasticity while moisturizing, hydrating, protecting the skin against environmental stressors and minimizing existing damage. Recommended to be included in your daily exercise routine prior to daily work-out to sooth sore muscles, firm, lift, and tone your body. It contains a robust combination of multi-functional ingredients working in synergy to leave you feeling toned and luminous.						</p>
						<p class="dpTherapy">
						Dermatologist Tested.
						</p>
						<p class="dpTherapy">
