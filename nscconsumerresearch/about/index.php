...
<body>
 ...
 <script>
    ...
    <div class="row">
        <div class="col-xs-12">
            <hr class="aboutUs" />
            <p>Nerium SkinCare products are founded on the technology, core science, and research of Nerium Biotechnology, Inc. (NBI) 
            utilizing a patented ingredient “Nerium Aloe Extract”. This proprietary technology incorporates pure liquid Aloe Vera as the 
            media used to acquire the unique Nerium oleander plant components in a way that preserves the unique and beneficial properties of 
            both plants, without additional solvents. </p>
        </div>
    </div>
      ...
      <div class="accordion">
          ...
          <div class="accordion-section">
              ...
              <div id="accordion-2" class="accordion-section-content">
                <p> Historical use of the Nerium oleander plant for medicinal applications has been reported in ancient texts and folklore for more than 1500 years. 
                The Nerium oleander plant has been used traditionally as folk remedies for a wide variety of maladies and conditions, including dermatitis, eczema, psoriasis,
                 herpes, sores, abscesses, warts, corns, skin cancer, ringworm, scabies, epilepsy, asthma, malaria dysmenorrheal, emetics, diuretics and heart tonics. Historical 
                 use of Aloe Vera is well known</p>
              </div>
          </div>
          ...
          <div class="accordion-section">
              ...
              <div id="accordion-3" class="accordion-section-content">
                ...
                <br />
                <p>Unique commercial Nerium oleander farming operation, earth friendly and environmentally responsible. Nerium Farms is the source for the Nerium Oleander
                 biomass for research and product development. Nerium SkinCare’s first-of –class product quality is controlled from the “farm to the consumer”. </p>   
            </div>
          </div>
          <!-- Third Accordion End -->
          ...
          <div class="accordion-section">
              ...
              <div id="accordion-5" class="accordion-section-content">
                ...
                <div class="responsive-video">
                  <iframe width="560" height="315" src="https://www.youtube.com/embed/ynkE-RqHC-k" frameborder="0" gesture="media" allowfullscreen></iframe>               
                </div>
