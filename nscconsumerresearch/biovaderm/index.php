  ...
  italic {
	...
	<div class="row">
		...
		<div class="col-xs-12">
          ...
          <hr class="biovaderm"> 
              <img src="../images/skincell.jpg" width=250 height=180 class="demo1">
...
<h4>Component (Sample B) on Oxidant and Skin Aging Endpoints in the EpiDerm FT in vitro Skin Model</h4>
<br/>
<h4>Study Number: 015-14b</h4>
<h4>Sample B:</h4>           
<br/>
<h4>Biova powder (egg shell membrane)</h4>    
  <br/>          
<p>This study evaluated the safety of Sample B by assessing tissue viability in a human skin model at three varying concentrations.  In addition, the study also evaluated the effects of Sample B on the biomarkers of oxidation and skin-aging in a human skin using that model. The results indicate that tissue integrity was intact and viability was not affected when the skin model was treated with Sample B.  This was also true when the tissue was histologically evaluated for toxicity at the dose indicated for efficacy. 
