...
<div class="row">
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:834px;height:290px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:838px;height:270px;overflow:hidden;">
            <div>
                <img data-u="image" src="images/therapypage/slider/NSC.TL.Web.Carousel.CS.V6.jpg" />
            </div>
            <div>
		...
		<div id="tabs-1">
			...
			<div class="row">
				...
				<div class="row">
					...
					<div class="row">				
						<div class="col-md-12">
							<p class="csDailyLipMaintenance">Daily Lip Maintenance works to provide moisture and overall lip health. With the powerful active ingredient allantoin and patented Nerium oleander extract, this formula incorporates the sun protection ingredient ethylhexyl methocinnamate, to ensure that your lips are protected from all harmful environmental elements and stressors.</p>
						</div>
					</div>
			   <hr class="redHR" />
				</div>
			...
			<div class="row">
				<h1 class="lipTherapy">HOW TO USE</h1>
					...
					<div class="col-sm-3 visible-lg visible-md">
						<p class="csHowToUse"><span>Use Daily Lip Maintenance:</span><br />Apply as needed to delay reoccurrence and for continuous lip health. Use only after cold sore is fully healed. Recommended to clean applicator in between use.</p>
					</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-sm-6 hidden-lg hidden-md">
					<p class="csHowToUse"><span>Use Daily Lip Maintenance:</span> Apply as needed to delay reoccurrence and for continuous lip health. Use only after cold sore is fully healed. Recommended to clean applicator in between use.</p>
				</div>
				<div class="col-sm-2 hidden-lg hidden-md"></div>	
			</div>
