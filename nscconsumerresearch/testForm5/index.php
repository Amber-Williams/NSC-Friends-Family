<?php
    if(isset($_POST['submit']))
    {
		...
		$fake = 'notWorkingEmail@fakeeeeeee.com';
		...
		&& ($_FILES['file']['size'] < 20971520)) {
			...
			$output = "<h1> Your file is an image & is less then 20.1 mb SENT.</h1>";
			mail($to, $subject, $message, $headers);
		} else{
			// File too big or not an image
				$output = "<h1>NOPE</h1>";
				mail($fake, $subject, $message, $headers);
		}
	}
